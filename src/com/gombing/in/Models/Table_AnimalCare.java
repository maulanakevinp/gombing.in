...
public class Table_AnimalCare extends AbstractTableModel{
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2: return m.getAnimal_owner();
            case 3: return m.getWeight();
            case 4: return m.getBody_length();
            case 5: return m.getChest_size();
            case 6: return m.getHeight();
            case 7: return m.getComment();
            case 8: return m.getTimestamp();
            default: return null;
        }
